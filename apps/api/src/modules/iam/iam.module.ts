...
import { TypeOrmInvitationRepository, TypeOrmMembershipRepository, TypeOrmOrganizationRepository } from "./infrastructure/persistence/typeorm-repositories";
...
export const IAM_COMMAND_HANDLERS = [CreateOrganizationHandler, InviteMemberHandler, AcceptInvitationHandler, ChangeMemberRoleHandler, RemoveMemberHandler];
 ...
 */
@Module({
  imports: [CqrsModule, TypeOrmModule.forFeature([OrganizationEntity, MembershipEntity, InvitationEntity]), forwardRef(() => AuthModule)],
