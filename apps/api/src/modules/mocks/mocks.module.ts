...
export const MOCK_COMMAND_HANDLERS = [CreateMockHandler, UpdateMockHandler, RotateMockKeyHandler, DeleteMockHandler];
export const MOCK_QUERY_HANDLERS = [ListMocksHandler, AnswerMockHandler];
...
@Module({
  imports: [
    ...
    AuthModule,
    IamModule,
    TypeOrmModule.forFeature([MockServerEntity]),
